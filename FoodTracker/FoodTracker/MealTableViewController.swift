...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals () {
        ...
        let meal1 = Meal(name: "Pumpkin Soup", photo: photo1, rating: 5)!
        
        let photo2 = UIImage(named: "2")!
        let meal2 = Meal(name: "Baked Potato", photo: photo2, rating: 5)!
        
        let photo3 = UIImage(named: "3")!
        let meal3 = Meal(name: "Berry Sorbet", photo: photo3, rating: 4)!
